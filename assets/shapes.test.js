...
describe('Traingle', () => {
  it('should return a Triangle shape with SVG text inside', () => {
    ...
    expect(triangle.generateTriangle()).toEqual(`<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon height="100%" width="100%" points="0,200 300,200 150,0" fill="${bgcolor}"/>${text}</svg>`);
  });
});
...
describe('Circle', () => {
  it('should return a Circle shape with SVG text inside', () => {
    ...
    expect(circle.generateCircle()).toEqual(`<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><circle cx="50%" cy="50%" r ="100" height="100%" width="100%" fill="${bgcolor}"/>${text}</svg>`);
  });
});
